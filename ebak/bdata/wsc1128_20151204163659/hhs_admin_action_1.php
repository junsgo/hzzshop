...
E_D("replace into `hhs_admin_action` values('52','11','area_manage','');");
...
E_D("replace into `hhs_admin_action` values('75','11','friendlink','');");
E_D("replace into `hhs_admin_action` values('76','11','db_backup','');");
E_D("replace into `hhs_admin_action` values('77','11','db_renew','db_backup');");
E_D("replace into `hhs_admin_action` values('87','3','account_manage','');");
E_D("replace into `hhs_admin_action` values('88','5','flash_manage','');");
E_D("replace into `hhs_admin_action` values('89','11','navigator','');");
E_D("replace into `hhs_admin_action` values('95','2','article_auto','');");
E_D("replace into `hhs_admin_action` values('96','11','cron','');");
E_D("replace into `hhs_admin_action` values('97','11','affiliate','');");
E_D("replace into `hhs_admin_action` values('105','1','picture_batch','');");
E_D("replace into `hhs_admin_action` values('109','11','sitemap','');");
...
E_D("replace into `hhs_admin_action` values('131','11','reg_fields','');");
E_D("replace into `hhs_admin_action` values('135','4','role_manage','');");
E_D("replace into `hhs_admin_action` values('5','0','sys_manage','');");
