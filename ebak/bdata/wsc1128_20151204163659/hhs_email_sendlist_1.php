...
E_D("replace into `hhs_email_sendlist` values('68','','6','','0','1','1438942002');");
E_D("replace into `hhs_email_sendlist` values('69','','6','','0','1','1438942218');");
E_D("replace into `hhs_email_sendlist` values('70','','6','','0','1','1438942315');");
E_D("replace into `hhs_email_sendlist` values('71','','6','','0','1','1438998965');");
E_D("replace into `hhs_email_sendlist` values('72','','6','','0','1','1439016225');");
E_D("replace into `hhs_email_sendlist` values('73','','6','','0','1','1439021131');");
E_D("replace into `hhs_email_sendlist` values('74','','6','','0','1','1439021183');");
E_D("replace into `hhs_email_sendlist` values('75','','6','','0','1','1439024314');");
E_D("replace into `hhs_email_sendlist` values('76','','6','','0','1','1439024389');");
E_D("replace into `hhs_email_sendlist` values('77','','6','','0','1','1439024752');");
E_D("replace into `hhs_email_sendlist` values('78','','6','','0','1','1439024761');");
E_D("replace into `hhs_email_sendlist` values('79','','6','','0','1','1439024783');");
E_D("replace into `hhs_email_sendlist` values('80','','6','','0','1','1439026199');");
E_D("replace into `hhs_email_sendlist` values('81','','6','','0','1','1439026365');");
E_D("replace into `hhs_email_sendlist` values('82','','6','','0','1','1439026376');");
E_D("replace into `hhs_email_sendlist` values('83','','6','','0','1','1439026387');");
E_D("replace into `hhs_email_sendlist` values('84','','6','','0','1','1439170396');");
E_D("replace into `hhs_email_sendlist` values('85','','6','','0','1','1439174473');");
E_D("replace into `hhs_email_sendlist` values('86','','6','','0','1','1439174482');");
E_D("replace into `hhs_email_sendlist` values('87','','6','','0','1','1439176607');");
E_D("replace into `hhs_email_sendlist` values('88','','6','','0','1','1439176641');");
E_D("replace into `hhs_email_sendlist` values('89','','6','','0','1','1439177403');");
E_D("replace into `hhs_email_sendlist` values('90','','6','','0','1','1439177417');");
E_D("replace into `hhs_email_sendlist` values('91','','6','','0','1','1439177477');");
E_D("replace into `hhs_email_sendlist` values('92','','6','','0','1','1439177495');");
E_D("replace into `hhs_email_sendlist` values('93','','6','','0','1','1439186682');");
E_D("replace into `hhs_email_sendlist` values('94','','6','','0','1','1439434548');");
E_D("replace into `hhs_email_sendlist` values('95','','6','','0','1','1442313168');");
