...
E_D("replace into `hhs_shop_config` values('101','1','shop_name','text','','','1234','1');");
E_D("replace into `hhs_shop_config` values('102','1','shop_title','text','','','昊海拼团   【测试-网站演示专用】','1');");
...
E_D("replace into `hhs_shop_config` values('307','1','image_height','text','','','600','1');");
...
E_D("replace into `hhs_shop_config` values('317','3','goods_name_length','text','','','7','1');");
...
E_D("replace into `hhs_shop_config` values('920','1','open_team','text','','','1','1');");
E_D("replace into `hhs_shop_config` values('107','1','shop_city','manual','','','321','1');");
E_D("replace into `hhs_shop_config` values('108','1','shop_address','text','','','胜利路','1');");
E_D("replace into `hhs_shop_config` values('105','1','shop_country','manual','','','1','1');");
E_D("replace into `hhs_shop_config` values('106','1','shop_province','manual','','','25','1');");
E_D("replace into `hhs_shop_config` values('911','6','default_shipping_id','hidden','','','21','1');");
E_D("replace into `hhs_shop_config` values('912','0','share_info','group','','','','1');");
E_D("replace into `hhs_shop_config` values('913','912','index_share_title','text','','','这个商场不错，大家一起来拼单吧','1');");
E_D("replace into `hhs_shop_config` values('914','912','index_share_dec','text','','','来来来，这家商品不错，大家来拼单吧','1');");
...
E_D("replace into `hhs_shop_config` values('919','1','group_purchase','text','','','10','1');");
E_D("replace into `hhs_shop_config` values('115','1','service_phone','text','','','','1');");
E_D("replace into `hhs_shop_config` values('921','1','shop_notice','textarea','','','','1');");
E_D("replace into `hhs_shop_config` values('924','1','limit_index_goods_num','text','','','6','1');");
E_D("replace into `hhs_shop_config` values('925','1','subscribe_url','text','','','http://mp.weixin.qq.com/s?__biz=MzIyODAzNzA4OA==&mid=400596310&idx=1&sn=b4f599f92f45ee0eedec5549d64e5a41','1');");
E_D("replace into `hhs_shop_config` values('922','1','team_suc_time','text','','','2','1');");
E_D("replace into `hhs_shop_config` values('923','1','affirm_received_time','text','','','3','1');");
E_D("replace into `hhs_shop_config` values('926','1','qr_code','file','','../images/','../images/qrcode_for_gh_2442dc1689cb_258.jpg','1');");
