 ...
 * 添加商品到购物车 
 */
function addToCart(goodsId, parentId, is_ajax,rec_type,team_sign)
{
  ...
  if(is_ajax == 1){
	Ajax.call('flows.php?step=add_to_cart', 'goods=' + obj2str(goods), addToCartResponse_ajax, 'POST', 'JSON');
  }else{
...
function addToCartResponse_ajax(result)
{
  ...
  else
  {
    ...
    var cart_url = 'flows.php?step=checkout';
    if (cartInfo)
    {
...
function addPackageToCart(packageId)
{
  ...
  Ajax.call('flows.php?step=add_package_to_cart', 'package_info=' + obj2str(package_info), addPackageToCartResponse, 'POST', 'JSON');
}
...
var html = '';
//生成层内内容
html = '<div class="add_box"><div class="add_shop"><div class="add_shop_dh"><span class="gwlogo">已成功加入购物车!</span><span class="close"><a href="javascript:cancel_div()"><b>关闭</b></a></span></div><div class="clear"></div><div class="add_shop_con"><ul><li><span class="add_shopwz5"><a href="javascript:cancel_div()"><< 继续购物</a></span><span class="add_shopwz6"><a href="flows.php">去结算</a></span></li></ul></div></div></div>';
