 ...
 * ============================================================================
 * $Author: pangbin $
 * $Id: order.php 17217 2014-05-12 06:29:08Z pangbin $
 */ 
/* 团购 */
$_LANG['team_sign'] = '团购编号';
...
$_LANG['cs'][CS_AWAIT_PAY] = '已确认待付款';
$_LANG['cs'][CS_AWAIT_SHIP] = '待发货';
$_LANG['cs'][CS_PAYED] = '已付款';
$_LANG['cs'][CS_SHIPPED] = '已发货';
...
$_LANG['bonus_not_available'] = '该订单使用优惠劵支付，现在优惠劵不可用';
...
$_LANG['merge'] = '合并';
$_LANG['notice_order_sn'] = '当两个订单不一致时，合并后的订单信息（如：支付方式、配送方式、包装、贺卡、优惠劵等）以主订单为准。';
