...
$_LANG['cfg_name']['shop_name'] = '微店名称';
$_LANG['cfg_name']['shop_title'] = '微店标题';
$_LANG['cfg_name']['shop_website'] = '微店网址';
$_LANG['cfg_name']['shop_desc'] = '分享标题';
$_LANG['cfg_name']['shop_keywords'] = '微店关键字';
...
$_LANG['cfg_name']['shop_notice'] = '微店公告';
...
$_LANG['cfg_name']['use_bonus'] = '是否使用优惠劵';
...
$_LANG['cfg_name']['close_comment'] = '关闭微店的原因';
...
$_LANG['cfg_name']['shop_logo'] = '微店 Logo';
...
$_LANG['cfg_name']['sms_name'] = '短信接口账号';
$_LANG['cfg_name']['sms_password'] = '短信接口密码';
...
$_LANG['cfg_desc']['template'] = '目前两套模板(1. haohaios  2. haohainew)';
...
$_LANG['cfg_desc']['shop_title'] = '微店的标题将显示在浏览器的标题栏';
...
$_LANG['cfg_desc']['shop_notice'] = '以上内容将显示在首页微店公告中,注意控制公告内容长度不要超过公告显示区域大小。';
$_LANG['cfg_desc']['bgcolor'] = '颜色请以#FFFFFF格式填写';
$_LANG['cfg_desc']['use_how_oos'] = '使用缺货处理时前台订单确认页面允许用户选择缺货时处理方法。';
$_LANG['cfg_desc']['send_service_email'] = '微店信息中的客服邮件地址不为空时，该选项有效。';
...
$_LANG['gzip_confirm'] = "GZip 功能需要您的服务器支持 zlib 扩展库。\\n如果您发现开启Gzip后页面出现乱码，可能是您的服务器已经开启了Gzip，您不需要在 昊海电商 中再次开启。";
...
$_LANG['back_shop_config'] = '返回微店设置';
$_LANG['back_mail_settings'] = '返回邮件服务器设置';
$_LANG['mail_settings'] = '邮件服务器设置';


$_LANG['cfg_name']['bonus_par'] = '分享优惠券面值';

$_LANG['cfg_name']['share_info'] = '分享模板';
$_LANG['cfg_name']['index_share_title'] = '默认分享标题';
$_LANG['cfg_name']['index_share_dec'] = '默认分享描述';
$_LANG['cfg_name']['goods_share_title'] = '商品分享标题';
$_LANG['cfg_name']['goods_share_dec'] = '商品分享描述';
//$_LANG['cfg_name']['group_share_title'] = '组团分享标题';
$_LANG['cfg_name']['group_share_dec'] = '组团分享描述';
$_LANG['cfg_name']['group_share_ads'] = '组团分享广告标语';

$_LANG['cfg_name']['group_purchase'] = '附近团的距离（公里）';
$_LANG['cfg_name']['open_team'] = '开启拼团';
$_LANG['cfg_name']['affirm_received_time'] = '自动确认收货';


$_LANG['cfg_name']['limit_index_goods_num'] = '首页分类下商品显示个数';

$_LANG['cfg_desc']['affirm_received_time'] =  '以天为单位';
$_LANG['cfg_name']['team_suc_time'] = '成团时间';
$_LANG['cfg_desc']['team_suc_time'] =  '以天为单位';
