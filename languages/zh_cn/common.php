...
$_LANG['use_bonus'] = '使用优惠劵';
$_LANG['use_bonus_kill'] = '使用线下优惠劵';
$_LANG['invoice'] = '开发票';
...
$_LANG['p_y']['link_start'] = '<a href="http://www.xaphp.cn" target="_blank" style=" font-family:Verdana; font-size:11px;">';
