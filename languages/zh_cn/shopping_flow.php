 ...
 * ============================================================================
 * $Author: pangbin $
 * $Id: shopping_flow.php 17217 2014-05-12 06:29:08Z pangbin $
*/
...
$_LANG['invalid_bonus'] = "您选择的优惠劵并不存在。";
...
$_LANG['remember_order_number'] = "订单号";
...
$_LANG['validate_bonus'] = '验证优惠劵';
$_LANG['input_bonus_no'] = '或者输入优惠劵序列号';
$_LANG['select_bonus'] = '选择已有优惠劵';
$_LANG['bonus_sn_error'] = '该优惠劵序列号不正确';
$_LANG['bonus_min_amount_error'] = '订单商品金额没有达到使用该优惠劵的最低金额 %s';
$_LANG['bonus_is_ok'] = '该优惠劵序列号可以使用，可以抵扣 %s';
