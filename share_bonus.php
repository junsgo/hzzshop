...
if ($act == 'default'){
	...
	$smarty->assign('goods_name', $_CFG['shop_name']."给您发券了，买商品直接抵现金");
	$smarty->assign('goods_brief',  mb_substr($_CFG['shop_desc'], 0,30,'utf-8') );//mb_substr($goods_list[0]['goods_brief'], 0,30,'utf-8')
