...
//数据库管理
   ...
   // $purview['04_sql_query']         = 'sql_query';
    ...
    $purview['01_wxconfig']          = 'wxconfig';
    $purview['02_config']            = 'config';
    $purview['03_regmsg']            = 'regmsg';
    $purview['04_keywords']          = 'keywords';
    $purview['05_menu']              = 'menu';
    $purview['06_bonus']             = 'bonus';
